...
En este ejercicio, debes crear el código HTML necesario para rrepresentar una tarjeta de perfil. El código final cambiará en tiempo de ejecución y enn función de una serie de variables que podrían cambiar.
