...
function render(variables = {}) {
  ...
  if (variables.lastname === null) {
    variables.lastname = "Calderon";
  }
  if (variables.role === null) {
    variables.role = "Developer";
  }
  if (variables.city === null) {
    variables.city = "San Jose";
  }
...
window.onload = function() {
  window.variables = {
    ...
    avatarURL:
      "https://thumbs.dreamstime.com/z/personaje-de-dibujos-animados-de-la-rana-91709519.jpg",
    // social media bar position (left or right)
    socialMediaPosition: "position-left",
    // social media usernames
    twitter: null,
    github: "/danielcalderon-ux",
    linkedin: null,
    instagram: null,
    name: null,
    lastname: null,
