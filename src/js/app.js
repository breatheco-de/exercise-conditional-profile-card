...
function render(variables = {}) {
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <h1>
            ...
            ${variables.lastName == null ? "Castellón" : variables.lastName}
          </h1>
          <h2>
          ...
          <ul class="${variables.socialMediaPosition}">
            <li><a target="_blank" href="https://x.com/${
              variables.twitter == null ? "cristiano" : variables.twitter
            }"><i class="fab fa-twitter"></i></a></li>
            <li><a target="_blank" href="https://github.com/${
              variables.github == null ? "kev-torrico" : variables.github
            }"><i class="fab fa-github"></i></a></li>
            <li><a target="_blank" href="https://www.linkedin.com/in/${
              variables.linkedin == null
                ? "kevin-cristhian-villca-torrico"
                : variables.linkedin
            }"><i class="fab fa-linkedin"></i></a></li>
            <li><a target="_blank" href="https://www.instagram.com/${
              variables.instagram == null ? "leomessi" : variables.instagram
